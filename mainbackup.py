...
def handle_form():
    ...
    print("printing data to pass to the API request")
    # print(files_data) #comment off for large data
    ...
    for (name, data) in zip (uploadedfile_list, files_data_topost):
        ...
        print("request posted in the LOOP")
        ...
        # need sleep to wait for the analyzed data to be ready
        time.sleep(15)
